...
bool Tool_RectEdgesDraw::gererMouseMove(QMouseEvent* event) {
    ...
    if (!m_isDrawingRect) {
        ...
        m_Cotation2_bDescriptorDefined = true;
        m_Cotation1_currentDimensionDescriptor.data = m_Cotation1_DistDesc;
        DimensionEngine::GeometryResult Cot1_geoResult = DimensionEngine::ComputeGeometry( m_Parent->PartRefs.GetSketchPlane(), m_Cotation1_currentDimensionDescriptor);
        m_Parent->m_Cotation2->DessinerCotationDepuisResultat(m_Parent->PartRefs.GetSketchPlane(), Cot1_geoResult);
...
/*
    ...
    Line_AB.start.Update3D( m_Parent->PartRefs.GetSketchPlane() );
    Line_AB.stop.Update3D ( m_Parent->PartRefs.GetSketchPlane() );
    Line_BC.start.Update3D( m_Parent->PartRefs.GetSketchPlane() );
    Line_BC.stop.Update3D ( m_Parent->PartRefs.GetSketchPlane() );
    Line_CD.start.Update3D( m_Parent->PartRefs.GetSketchPlane() );
    Line_CD.stop.Update3D ( m_Parent->PartRefs.GetSketchPlane() );
    Line_DA.start.Update3D( m_Parent->PartRefs.GetSketchPlane() );
    Line_DA.stop.Update3D ( m_Parent->PartRefs.GetSketchPlane() );
